 ...
 */
public class RestaTuring {

    /**
     * @param args the command line arguments
     */
    public static void main(String[] args) {
        Principal principal = new Principal(); // Declaración de la clase que tiene el formato gráfico
        principal.setVisible(true); //Despliegue de la ventana gráfica
    }
